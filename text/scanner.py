...
class Scanner:
    ...
    def __on_keyword(self):
        ...
        elif    value == 'struct':      return Token(Token.TOKT_STRUCT,     start, end)
        elif    value == 'enum':        return Token(Token.TOKT_ENUM,       start, end)
        elif    value == 'function':    return Token(Token.TOKT_FUNCTION,   start, end)
        elif    value == 'macro':       return Token(Token.TOKT_MACRO,      start, end)
